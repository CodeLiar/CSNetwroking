...
#import "UIDevice+CSNetworkingMethods.h"
#import "CSLocationManager.h"

@interface CSAppContext ()
...
{
    static CSAppContext *sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[CSAppContext alloc] init];
...
- (CGFloat)latitude
{
    return [CSLocationManager sharedInstance].currentLocation.coordinate.latitude;
}

- (CGFloat)longitude
{
    return [CSLocationManager sharedInstance].currentLocation.coordinate.longitude;
}

- (void)appStarted
{
    self.sessionId = [[NSUUID UUID].UUIDString copy];
    [[CSLocationManager sharedInstance] startLocation];
}

- (void)appEnded
{
    [[CSLocationManager sharedInstance] stopLocation];
}
